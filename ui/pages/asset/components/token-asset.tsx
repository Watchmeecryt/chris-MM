...
import { isConfidentialErc7984Token } from '../../../../shared/lib/confidential-erc7984/registry';
import AssetOptions from './asset-options';
import AssetPage from './asset-page';
import { ConfidentialErc7984BalancePanel } from './confidential-erc7984-balance-panel';
...
const TokenAsset = ({ token, chainId }: { token: Token; chainId: Hex }) => {
  ...
  const showErc7984Panel =
    isEvm && isConfidentialErc7984Token(chainId, address);
  ...
  return (
    <AssetPage
      ...
      erc7984ConfidentialPanel={
        showErc7984Panel ? (
          <ConfidentialErc7984BalancePanel
            chainId={chainId}
