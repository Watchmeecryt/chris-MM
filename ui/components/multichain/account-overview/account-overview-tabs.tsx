...
export type AccountOverviewTabsProps = AccountOverviewCommonProps & {
  ...
  showDefi?: boolean;
  /** ERC-7984 / Zama: tab that scans known confidential wrappers for non-zero handles */
  showPrivateConfidential?: boolean;
};
...
export const AccountOverviewTabs = ({
  ...
  return (
    ...
    >
      ...
      {showPrivateConfidential && (
        <Tab
          name={t('privateBalance')}
          tabKey={AccountOverviewTabKey.PrivateBalance}
